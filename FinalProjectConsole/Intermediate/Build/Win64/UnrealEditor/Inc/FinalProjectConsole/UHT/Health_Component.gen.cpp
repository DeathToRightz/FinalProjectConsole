...
#endif // WITH_METADATA
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ActorToTakeDamage;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHealth_Component_TakeDamage_Statics::NewProp_ActorToTakeDamage = { "ActorToTakeDamage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Health_Component_eventTakeDamage_Parms, ActorToTakeDamage), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UHealth_Component_TakeDamage_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UHealth_Component_TakeDamage_Statics::NewProp_ActorToTakeDamage,
...
{
	P_GET_OBJECT(AActor,Z_Param_ActorToTakeDamage);
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->TakeDamage(Z_Param_ActorToTakeDamage,Z_Param_Damage,Z_Param_DamageType,Z_Param_InstigateBy,Z_Param_DamageCauser);
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UHealth_Component_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MaxHealth_MetaData[] = {
		...
		{ "Comment", "//Max health that we can edit for the player and or enemies\n" },
#endif
		{ "ModuleRelativePath", "Health_Component.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Max health that we can edit for the player and or enemies" },
#endif
	};
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHealth_Component_TakeDamage, "TakeDamage" }, // 2197304968
	};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHealth_Component_Statics::NewProp_Health = { "Health", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHealth_Component, Health), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Health_MetaData), NewProp_Health_MetaData) };
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_lmcordova1_Documents_GitHub_FinalProjectConsole_FinalProjectConsole_Source_FinalProjectConsole_Health_Component_h__Script_FinalProjectConsole_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHealth_Component, UHealth_Component::StaticClass, TEXT("UHealth_Component"), &Z_Registration_Info_UClass_UHealth_Component, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHealth_Component), 139900080U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_lmcordova1_Documents_GitHub_FinalProjectConsole_FinalProjectConsole_Source_FinalProjectConsole_Health_Component_h__Script_FinalProjectConsole_229642537(TEXT("/Script/FinalProjectConsole"),
	Z_CompiledInDeferFile_FID_Users_lmcordova1_Documents_GitHub_FinalProjectConsole_FinalProjectConsole_Source_FinalProjectConsole_Health_Component_h__Script_FinalProjectConsole_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_lmcordova1_Documents_GitHub_FinalProjectConsole_FinalProjectConsole_Source_FinalProjectConsole_Health_Component_h__Script_FinalProjectConsole_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
